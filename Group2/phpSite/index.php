<?php
$arr = [23 => 'dhfghdf', 13 => 'kjfdhkj', 12 => 'fdkh', 4 => 'kjhkr', 8 => 'akjh'];
          ...
          <div class="carousel-inner rounded">
            <div class="carousel-item overlay carousel-height active">
              ...
              <div class="carousel-caption d-none d-md-block">
                <h5>مجرب ترین کادر آموزشی</h5>
                <p>پیشگام در آموزش دوره های پیشرفته برنامه نویسی</p>
              </div>
            </div>
            <div class="carousel-item carousel-height overlay">
              <img src="./assets/images/2.jpg" class="d-block w-100" alt="post-image" />
              <div class="carousel-caption d-none d-md-block">
                <h5>آموزش هوش مصنوعی</h5>
                <p>آموزش دروس تخصصی مهندسی کامپیوتر</p>
              </div>
            </div>
            <div class="carousel-item carousel-height overlay">
              <img src="./assets/images/3.jpg" class="d-block w-100" alt="post-image" />
              <div class="carousel-caption d-none d-md-block">
                <h5>آموزش دروس تخصصی</h5>
                <p>برنامه نویسی رو با خیال راحت یاد بگیر</p>
              </div>
            </div>
          </div>
            ...
            <div class="card mt-4">
              ...
              <ul class="list-group list-group-flush p-0">
                <li class="list-group-item">
                  <a class="link-body-emphasis text-decoration-none" href="#">برنامه نویسی</a>
                </li>
                <li class="list-group-item">
                  <a class="link-body-emphasis text-decoration-none" href="#">شبکه</a>
                </li>
                <li class="list-group-item">
                  <a class="link-body-emphasis text-decoration-none" href="#">اخبار فناوری</a>
                </li>
                <li class="list-group-item">
